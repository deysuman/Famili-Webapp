...
export default class CommentEdit extends Component{
    ...
    commentAjaxSubmit () {
        ...
        document.getElementById("React-Comment_id" + update_id).classList.add("none");
        $(document.getElementById("Edit_tool" + update_id)).val('').blur();
    ...
    handleTests (e){
            ...
            if (e.shiftKey && e.keyCode == 13) {
                ...
                let user_comment = document.getElementById("Edit_tool"+update_id).value.trim();
    ...
    render (){
		...
		return (
		    <div className="hiddnetextarea none" ref="myele"  id={"React-Comment_id"+this.state.comid}>
                <form>
                    <textarea ref="me"
                              id={"Edit_tool"+this.state.comid}
