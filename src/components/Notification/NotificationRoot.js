...
export default class NotificationRoot extends Component{
    ...
    Loadnotification ()
    {
        ...
        if(ram==0){
            ...
            let authorwho = myid;
            let wrap = document.getElementById('notificationFeed');
            let contentHeight = wrap.offsetHeight;
            let offset = $("#notificationFeed").offset();
            let yOffset = offset.top;
            let y = yOffset + document.getElementById("notificationFeed").offsetHeight;

            //console.log("contentheight "+contentHeight + "&&&" + document.getElementById("notificationFeed").offsetHeight);
            ...
            if (y => contentHeight) {
                ...
                if(document.getElementById("loading_notification")!=null){
                    ...
                    document.getElementById("loading_notification").classList.remove("none");
                    ...
                    if (hr.readyState == 4 && hr.status == 200) {
                        ...
                        if (totalNotificationpage != 1) {
                            ...
                            if (pn != totalNotificationpage) {
                                ...
                                document.getElementById("notificationFeed").onscroll = !reactThis.Loadnotification;
                            }
    ...
    componentDidMount ()
    {
        ...
        if(document.getElementById("notificationFeed")!=null){
            if(totalNotificationpage<=currentNotificationpage){

                document.getElementById("notificationFeed").addEventListener("scroll",yhandler,false);
            }
        }
    ...
    Router()
    {
        ...
        if(this.state.notifications.length > 0){
            ...
            return (<Notification data={this.state.notifications}/>)
            ...
            return (
                <div style={nu} id="notificationFeed">
                {
                    this.Loadingbar()
                }
            </div>
