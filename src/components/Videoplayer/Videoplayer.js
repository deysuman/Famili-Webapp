...
class Video extends Component {
  ...
  constructor(props, context) {
    ...
    this._stopwheniclickanother = this._stopwheniclickanother.bind(this);
  ...
  _timeupdate(e) {
    ...
    this.props.seekupdate(this.$video.currentTime);
  ...
  render() {
    ...
    if (!this.props.controls)
      controlsClass = "r5-controls-hidden";


    return (
      <div className="r5-wraper" style={wraperStyle}>
        <button onClick={this._stopwheniclickanother} className="soi" style={us}></button>
				...
				<div className={controlsClass}>
					<div className="r5-seekbar-wraper" ref="seekbarWraper">
						<div className="r5-seekbar-loaded" ref="seekbar" style={{
        width: this.state.loadedProgress + "%"
      }}></div>
						<div className="r5-seekbar" ref="loadedbar" style={{
      ...
      onChange={e => this._setTime(e.target.value, true)} />
					...
					<div className="r5-panel">
						...
						<div className="r5-volume">
							...
							<div className="r5-volume-inner" style={{
        width: "80px"
      }}>
								<div className="r5-volume-bar" style={{
